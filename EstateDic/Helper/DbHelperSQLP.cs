...
namespace EstateDic
{
    public class DbHelperSQLP
    {
        ...
        public void CopyTaskCustomerTable(DataTable dt, string tableName)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                connection.Open();
               ...
               new SqlBulkCopyColumnMapping(dc.ColumnName, dc.ColumnName);
        ...
        public int ExecuteSqlTranAndError(List<String> SQLStringList, out string msg)
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                conn.Open();
